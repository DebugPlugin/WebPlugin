...
const CHAT_SYSTEM_PROMPT =
  ...
  "Usa sempre gli strumenti disponibili per ispezionare il codice reale prima di rispondere — non serve chiedere all'utente di scaricare nulla prima, " +
  "gli strumenti scaricano automaticamente la versione richiesta se non è già presente. " +
  "Le versioni sono identificate da tag come restituiti da list_versions (es. v8.2.3); se l'utente scrive la versione senza la 'v' iniziale, prova comunque a usarla con la 'v'. " +
  "Rispondi in modo preciso, citando percorsi di file e numeri di riga quando è utile. Se una versione non esiste nel repository, dillo chiaramente.";
