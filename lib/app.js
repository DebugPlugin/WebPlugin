...
const CHAT_SYSTEM_PROMPT =
  "You are an assistant embedded in a web app for exploring the source code of Doofinder's PrestaShop plugin. " +
  ...
  "Versions are identified by tags as returned by list_versions (e.g. v8.2.3); if the user writes the version without the leading 'v', try it with the 'v' anyway. " +
